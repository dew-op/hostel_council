    ...
    return (
        <div id="Contact us" className='w-full flex flex-wrap py-16 bg-black text-white'>
            ...
            <div className="flex flex-col text-center lg:text-left px-20 gap-1 lg:gap-6 w-full lg:w-[25%]">
                ...
                <a href="https://iitr.ac.in/" target='_blank' rel='noreferrer' className="text-gray-500 font-poppins">IIT Roorkee</a>
                <a href="https://outreach.iitr.ac.in/" target='_blank' rel='noreferrer' className="text-gray-500 font-poppins">Outreach</a>
                <a href="https://wellness.iitr.ac.in/" target='_blank' rel='noreferrer' className="text-gray-500 font-poppins">Wellness</a>
                <a href="https://iitr.ac.in/Campus%20Life/Sports/index.html" target='_blank' rel='noreferrer' className="text-gray-500 font-poppins">Sports</a>
                <a href="https://iitr.ac.in/Departments/index.html" target='_blank' rel='noreferrer' className="text-gray-500 font-poppins">Department</a>
                <a href="https://ir.iitr.ac.in/" target='_blank' rel='noreferrer' className="text-gray-500 font-poppins">International Student</a>
                <a href="https://iitr.ac.in/Administration/Student%20Affairs%20Council.html" target='_blank' rel='noreferrer' className="text-gray-500 font-poppins">SAC</a>
            </div>
            <div className="flex flex-col items-center text-left lg:items-start px-8 lg:px-20 gap-6 w-full mt-10 lg:mt-0 lg:w-[39%]">
                ...
                <div className="flex flex-col w-full">
                    ...
                    <hr className="border-t-2 w-20 mx-auto lg:mx-0 border-white" />
                    <div className="mt-4">
                        <iframe className='border-0 h-60 w-full lg:w-4/5 rounded-lg' title='map' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3459.9183662112623!2d77.89724787554691!3d29.866628025013625!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390eb32bac1adc93%3A0x80bba7dd5e4d1a6a!2sStudents%20Activity%20Centre%20-%20SAC!5e0!3m2!1sen!2sin!4v1719039496909!5m2!1sen!2sin" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
        </div>
